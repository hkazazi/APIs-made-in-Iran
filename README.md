...
[API گپ](https://my.gap.im/documents/fa/) | امکان تبادل پیام و پرداخت از طریق پیام‌رسان گپ
...
[API واکاویک](http://docs.vakavic.com/) | سرویس پردازش متن با قابلیت‌هایی نظیر دسته‌بندی و خلاصه‌کردن متن و نظارت بر کامنت‌ها
[API فارس‌نت](http://farsnet.nlp.sbu.ac.ir/Site3/Modules/Public/Default.jsp) | سرویس قابل استفاده در دات‌نت و جاوا برای شبکه واژگانی مورد استفاده در پردازش زبان طبیعی فارسی
[API نشان](https://developer.neshan.org/) | API توسعه نقشه نشان که برای دریافت آن نیاز به ثبت‌نام دارید
[API سیدار مپ](http://api.cedarmaps.com/docs/) | سرویس نقشه ایرانی با قابلیت‌هایی نظیر تبدیل نقطه جغرافیایی به آدرس و مکان یاب و جانمایی روی نقشه
[API سایت map.ir](http://corp.map.ir/map-services/api-services/developers/) | یک سرویس دیگر نقشه ایرانی
[API پارسی مپ](https://www.parsimap.com/manual/api.html) | سرویس نقشه ایرانی با قابلیت استفاده عمومی یا اختصاصی
[API فلوکس](https://phelox.ir/document) | درگاه مدیریت و ارائه خدمات حمل، بسته بندی، لجستیک و انبارداری فروشگاه های اینترنتی
[API ابرینو](https://abrino.ir/developers) | سرویس ذخیره‌سازی اطلاعات ابری برای توسعه‌دهندگان موبایل و وب. دریافت API نیازمند تماس است
[API تشریفات فرودگاه مشهد](https://cipmashad.com/fa/cip.webservice.pdf) | سرویس تشریفات CIP فرودگاه بین‌المللی مشهد
[API های هالیدی](http://hiholiday.ir/webservice) | سرویس پروازهای چارتر و هتل‌های ایران
[API زال](https://github.com/behnamsabeti/zaal) | سرویس پردازش زبان طبیعی (NLP) زال
[API حساب‌فا](https://api.hesabfa.com) | سرویس حسابداری آنلاین 
[API پیام‌رسان سروش](https://soroush-app.ir/developer.html) | پیام‌رسان ایرانی سروش
[API اطلاعات شهرداری مشهد](http://developer.mashhad.ir/web_directory/100147-%D9%81%D9%87%D8%B1%D8%B3%D8%AA-API.html) | اطلاعات شاخص کیفیت هوا، ظرفیت لحظه‌ای پارکنیگ‌ها و نقشه و اطلاع‌رسانی اتوبوسرانی. برای دریافت اطلاعات نیازمند تماس هستید
[API پی‌پینگ](https://docs.payping.ir) | پلت‌فرم مالی پی‌پینگ شامل سرویس‌های پرداخت شخصی، آیتم‌های مالی، کدهای تخفیف و سرویس‌های مرتبط با فاکتور آنلاین با قابلیت گزارش گیری
[API آیدی پی](https://idpay.ir/web-service/) | سرویس درگاه پرداخت شخصی و کارت خوان مجازی
[API متن‌کاوی](https://api.text-mining.ir) | مجموعه API برای پردازش متن و متن‌کاوی فارسی [مستندات](https://docs.text-mining.ir)
[API خدمات شهری تهران](http://api.tehran.ir/) | مجموعه اطلاعات شهری تهران با قابلیت درخواست API
[API منحنی](https://planner.monhani.ir/) | API تجاری و غیر رایگان برای برنامه‌ریزی سفر
